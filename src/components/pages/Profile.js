...
function Profile(props){
    ...
    const followHandler = async () => {
      try {
        if(followed){
          await axiosJWT.put(`http://localhost:8000/api/user/${username}/unfollow`,
           {},
           {
          ...
          await axiosJWT.put(`http://localhost:8000/api/user/${username}/follow`,
          {},
          {
            headers: {Authorization: "Bearer " + currentUser.accessToken}
          });
    ...
    useEffect(()=> {
      const fetchUser = async () => {
        const res = await axios.get(`http://localhost:8000/api/user/u/${username}`);
            ...
            <ProfileContainer>
                <div className="profileWrapper">
                    <div className="profilePicture">
                        <img
                        src={user.profilePicture ? user.profilePicture : "../../defaultavatar.png"}
                        alt=""
                    ...
                    <div className="profileData">
                        <div className="profileSettings">
                            <span className="profileSettingsUsername">{currentUser.username}</span>
                            {currentUser.data.username === username ? (
                              <>
                                <a className="profileSettingsButton"
                      ...
                      {posts.map((p) => (
                        <div key={p._id} className="profilePostWrapper">
                          <div className="profilePost">
                            <img
                              src={p.imgurl ? p.imgurl : "../../images/thar1.jpg"}
                              alt=""
