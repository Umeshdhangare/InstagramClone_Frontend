            ...
            <div className='TopbarRight'>
              <div className='TopbarIcons'>
                  <div className='TopbarIconItem'>
                    <FiSearchStyled onClick={showBarSearchMobileHandler}></FiSearchStyled>
                  </div>
                  <div className='TopbarIconItem'>
                    <BsPlusSquareStyled onClick={() => {
                      setShowAddPost(true);
                    }}/>
                  </div>
                  <img 
                    ...
                    src={user.data.profilePicture ? user.data.profilePicture : "../../images/defaultavatar.png"}
                  />
                  {
                    showMenu && (
                      <div className='TopbarMenu'>
                        <span className='menuItems' onClick={() => {
